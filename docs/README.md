...
- [Release checklist](release-checklist.md): build, installation/update checks, backend validation, and publication requirements.
- [Linux system audio](linux-system-audio.md): Meeting Mode capture requirements and current platform limitations.
- [Windows update release checks](windows-update-release-checks.md): updater-specific validation.
- [Changelog](../CHANGELOG.md): released behavior and upcoming additions.

The Parakeet, Qwen3-ASR, Nemotron Streaming, and Moonshine expansion is currently **unreleased**. The published 2.5.2 installers predate it; documentation for the expansion describes a source checkout containing that implementation.
