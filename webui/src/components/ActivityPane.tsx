...
function eventDescription(event: AuditEvent): string {
  ...
  const descriptions: Record<string, string> = {
    ...
    review_begin: 'Started insight review',
    review_unavailable: 'Insight review is unavailable',
    review_finish: 'Checked insights for uncertainty',
    review_answer: 'Clarified an insight and its notes',
    review_skip: 'Skipped an insight question',
    review_reopen: 'Reopened an insight question',
