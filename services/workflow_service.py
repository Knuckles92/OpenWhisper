...
class WorkflowService(QObject):
    ...
    def _transcribe_large_audio(self, audio_file: str):
        ...
        try:
            ...
            chunk_files = audio_processing_service.split_audio_file(audio_file, progress_callback)
            ...
            if hasattr(backend, 'transcribe_chunks'):
                ...
                transcribed_text = audio_processing_service.combine_transcriptions(transcriptions)
