...
Download **OpenWhisper-Setup-2.3.0.exe** from [openwhisper.fiorilabs.tech](https://openwhisper.fiorilabs.tech/) or the [Releases page](https://github.com/Knuckles92/OpenWhisper/releases), then run it.
...
> ```powershell
> Get-FileHash .\OpenWhisper-Setup-2.3.0.exe -Algorithm SHA256
> ```
