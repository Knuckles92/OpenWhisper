...
Download **OpenWhisper-Setup-2.5.0.exe** from [openwhisper.fiorilabs.tech](https://openwhisper.fiorilabs.tech/) or the [Releases page](https://github.com/Knuckles92/OpenWhisper/releases), then run it.
...
> ```powershell
> Get-FileHash .\OpenWhisper-Setup-2.5.0.exe -Algorithm SHA256
> ```
...
Download **OpenWhisper-2.5.0-linux-amd64.deb** from the [Releases page](https://github.com/Knuckles92/OpenWhisper/releases), then install it with APT so required audio and Qt system libraries are resolved automatically:

```bash
sudo apt install ./OpenWhisper-2.5.0-linux-amd64.deb
```
...
Download **OpenWhisper-2.5.0-linux-x86_64.pkg.tar.zst** from the [Releases page](https://github.com/Knuckles92/OpenWhisper/releases), then install it with pacman so required audio and Qt system libraries are resolved automatically:

```bash
sudo pacman -U ./OpenWhisper-2.5.0-linux-x86_64.pkg.tar.zst
```
