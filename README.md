...
Download **OpenWhisper-Setup-2.4.2.exe** from [openwhisper.fiorilabs.tech](https://openwhisper.fiorilabs.tech/) or the [Releases page](https://github.com/Knuckles92/OpenWhisper/releases), then run it.
...
> ```powershell
> Get-FileHash .\OpenWhisper-Setup-2.4.2.exe -Algorithm SHA256
> ```
